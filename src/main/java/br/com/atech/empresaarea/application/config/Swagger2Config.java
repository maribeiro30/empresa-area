...
public class Swagger2Config {
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfo("API Empresa Aerea", "Serviços para integração de Empresa Aerea", "1.0.0", "",
                new Contact("Marco Ribeiro", "", "m-antonio-ribeiro@uol.com.br.com.br"), "", "", Collections.emptyList());
        return apiInfo;
    }
